...
from garimpo.agents.templates import (
...
from garimpo.agents.parsers.parsers import PythonOutputParser
from garimpo.agents.utils.regex import (
...
from garimpo.agents.tools.dataframe import get_dataframe_summary
from garimpo.agents.utils.logging import log_ai_function, log_ai_error
from garimpo.agents.utils.plotly import plotly_from_dict
from garimpo.agents.utils.sandbox import run_code_sandboxed_subprocess
from garimpo.agents.utils.messages import (
...
class DataVisualizationAgent(BaseAgent):
    ...
    from garimpo.agents import DataVisualizationAgent
...
def make_data_visualization_agent(
    ...
    import pandas as pd
    from langchain_openai import ChatOpenAI
    from garimpo.agents import data_visualization_agent
    ...
    def chart_instructor(state: GraphState):
        ...
        return {
            "recommended_steps": format_recommended_steps(
                get_message_text(recommended_steps).strip(),
